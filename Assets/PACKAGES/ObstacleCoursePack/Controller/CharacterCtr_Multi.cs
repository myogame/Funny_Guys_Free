...
public class CharacterCtr_Multi : MonoBehaviour {
	...
	void Start() {
		...
		{
			Destroy(GetComponent<CharacterCtr_Multi>());
        ...
        if (SceneManager.GetActiveScene().name == "GamePlay_7_Multiplay")
        {
          
			gameObject.transform.name = "Player_MultiPlay";
        }
